...
QollsForTopicId = new Meteor.Collection("qolls-for-topic");
...
MyShareCircleAssign = new Mongo.Collection("my-share-circle-assign");
TopicsForShareCircle = new Mongo.Collection("topics-for-circle");
TopicsForId = new Mongo.Collection("topics-for-id");

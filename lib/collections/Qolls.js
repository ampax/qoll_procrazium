...
ExtQollForQuestionaireId = new Meteor.Collection("ext-qoll-for-questionaire-id");
ExtQollEmbedQuestionaireId = new Meteor.Collection("ext-qoll-embed-questionaire-id");

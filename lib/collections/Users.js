...
MyPendingSubscriptions = new Meteor.Collection('my-pending-subscriptions');
MyPendingApprovalsReqGroup = new Meteor.Collection('my-pending-approvals-req-group');
...
CollabGroups = new Meteor.Collection("collab-groups");

GroupsForQuestionnaireId = new Meteor.Collection("groups-for-questionaire-id");

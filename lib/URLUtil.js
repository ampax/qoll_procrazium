...
URLUtil.SITE_URL = Meteor.absoluteUrl();
...
URLUtil.isDev = function() {
  return URLUtil.SITE_URL === 'http://localhost:3000/' 
  || URLUtil.SITE_URL === 'http://localhost:4000/' 
  || URLUtil.SITE_URL === 'http://localhost:5000/'
}
